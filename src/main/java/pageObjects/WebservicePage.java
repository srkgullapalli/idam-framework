...
public class WebservicePage {
    ...
    public static String triggerWebService(String filePath, DataTable table, TestContext context) {
        ...
        String baseURL = FileReaderManager.getInstance().getConfigReader().getapiBaseURL();
    ...
    public static void validateAPIResponse(DataTable table, TestContext testContext) {
        ...
        switch (inputMap.get("service")) {
            ...
            case "BlackListWhiteList":
                validateTicketStatus(jsonResponse, inputMap);
                break;
        }
    }

    private static void validateTicketStatus(String jsonResponse, Map<String, String> inputMap) {
        ...
        String actualTicketStatus = msgBody.getString("ticketStatus");
        if(inputMap.get("operation").equalsIgnoreCase("Blacklist")){
            Assert.assertEquals("Blacklist", actualTicketStatus);
        }else{
            Assert.assertEquals("Valid", actualTicketStatus);
        }
    }
